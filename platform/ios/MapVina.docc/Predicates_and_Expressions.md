...
Using `NSPredicate` with MapVina iOS
...
A number of [MapVina-specific functions](#MapVina-specific-functions) are also
available.
...
of a [MapVina-specific function](#MapVina-specific-functions) that takes an
...
The MapVina Style Spec defines some operators for which no custom
