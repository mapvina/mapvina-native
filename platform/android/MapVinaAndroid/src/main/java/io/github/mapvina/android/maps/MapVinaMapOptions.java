...
/**
 * Defines configuration MapVinaMapOptions for a MapVinaMap. These options can be used when adding a
 * map to your application programmatically (as opposed to via XML). If you are using a MapFragment,
 * you can pass these options in using the static factory method newInstance(MapVinaMapOptions).
 * If you are using a MapView, you can pass these options in using the constructor
 * MapView(Context, MapVinaMapOptions). If you add a map using XML, then you can apply these options
 * using custom XML tags.
 */
public class MapVinaMapOptions implements Parcelable {
  ...
  private double minPitch = MapVinaConstants.MINIMUM_PITCH;
  private double maxPitch = MapVinaConstants.MAXIMUM_PITCH;
  ...
  /**
   * Creates a new MapVinaMapOptions object.
   *
   * @deprecated Use {@link #createFromAttributes(Context, AttributeSet)} instead.
   */
  @Deprecated
  public MapVinaMapOptions() {
  }

  private MapVinaMapOptions(Parcel in) {
  ...
  /**
   * Creates a default MapVinaMapsOptions from a given context.
   *
   * @param context Context related to a map view.
   * @return the MapVinaMapOptions created from attributes
   */
  @NonNull
  public static MapVinaMapOptions createFromAttributes(@NonNull Context context) {
    return createFromAttributes(context, null);
  }

  /**
   * Creates a MapVinaMapsOptions from the attribute set.
   *
   * @param context Context related to a map view.
   ...
   */
  @NonNull
  public static MapVinaMapOptions createFromAttributes(@NonNull Context context, @Nullable AttributeSet attrs) {
    TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.mapvina_MapView, 0, 0);
    return createFromAttributes(new MapVinaMapOptions(), context, typedArray);
  }

  @VisibleForTesting
  static MapVinaMapOptions createFromAttributes(@NonNull MapVinaMapOptions mapvinaMapOptions,
                                                 @NonNull Context context,
                                                 @Nullable TypedArray typedArray) {
    float pxlRatio = context.getResources().getDisplayMetrics().density;
    mapvinaMapOptions.actionJournalPath(context.getFilesDir().getAbsolutePath());

    try {
      mapvinaMapOptions.camera(new CameraPosition.Builder(typedArray).build());

      // deprecated
      mapvinaMapOptions.apiBaseUrl(typedArray.getString(R.styleable.mapvina_MapView_mapvina_apiBaseUrl));

      String baseUri = typedArray.getString(R.styleable.mapvina_MapView_mapvina_apiBaseUri);
      if (!TextUtils.isEmpty(baseUri)) {
        // override deprecated property if a value of the new type was provided
        mapvinaMapOptions.apiBaseUri(baseUri);
      }

      mapvinaMapOptions.zoomGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiZoomGestures, true));
      mapvinaMapOptions.scrollGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiScrollGestures, true));
      mapvinaMapOptions.horizontalScrollGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiHorizontalScrollGestures, true));
      mapvinaMapOptions.rotateGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiRotateGestures, true));
      mapvinaMapOptions.tiltGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiTiltGestures, true));
      mapvinaMapOptions.doubleTapGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiDoubleTapGestures, true));
      mapvinaMapOptions.quickZoomGesturesEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiQuickZoomGestures, true));

      mapvinaMapOptions.maxZoomPreference(typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraZoomMax,
        MapVinaConstants.MAXIMUM_ZOOM));
      mapvinaMapOptions.minZoomPreference(typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraZoomMin,
        MapVinaConstants.MINIMUM_ZOOM));
      mapvinaMapOptions.maxPitchPreference(typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraPitchMax,
        MapVinaConstants.MAXIMUM_PITCH));
      mapvinaMapOptions.minPitchPreference(typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraPitchMin,
        MapVinaConstants.MINIMUM_PITCH));

      mapvinaMapOptions.compassEnabled(typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiCompass, true));
      mapvinaMapOptions.compassGravity(typedArray.getInt(R.styleable.mapvina_MapView_mapvina_uiCompassGravity,
        Gravity.TOP | Gravity.END));
      mapvinaMapOptions.compassMargins(new int[] {
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiCompassMarginLeft,
          FOUR_DP * pxlRatio)),
        ((int) typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiCompassMarginTop,
          FOUR_DP * pxlRatio)),
        ((int) typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiCompassMarginRight,
          FOUR_DP * pxlRatio)),
        ((int) typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiCompassMarginBottom,
          FOUR_DP * pxlRatio))});
      mapvinaMapOptions.compassFadesWhenFacingNorth(typedArray.getBoolean(
        R.styleable.mapvina_MapView_mapvina_uiCompassFadeFacingNorth, true));
      Drawable compassDrawable = typedArray.getDrawable(
        R.styleable.mapvina_MapView_mapvina_uiCompassDrawable);
      if (compassDrawable == null) {
        compassDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.mapvina_compass_icon, null);
      }
      mapvinaMapOptions.compassImage(compassDrawable);

      mapvinaMapOptions.logoEnabled(typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_uiLogo, true));
      mapvinaMapOptions.logoGravity(typedArray.getInt(R.styleable.mapvina_MapView_mapvina_uiLogoGravity,
        Gravity.BOTTOM | Gravity.START));
      mapvinaMapOptions.logoMargins(new int[] {
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiLogoMarginLeft,
          FOUR_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiLogoMarginTop,
          FOUR_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiLogoMarginRight,
          FOUR_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiLogoMarginBottom,
          FOUR_DP * pxlRatio))});

      mapvinaMapOptions.attributionTintColor(typedArray.getColor(
        R.styleable.mapvina_MapView_mapvina_uiAttributionTintColor, UNDEFINED_COLOR));
      mapvinaMapOptions.attributionEnabled(typedArray.getBoolean(
        R.styleable.mapvina_MapView_mapvina_uiAttribution, true));
      mapvinaMapOptions.attributionGravity(typedArray.getInt(
        R.styleable.mapvina_MapView_mapvina_uiAttributionGravity, Gravity.BOTTOM | Gravity.START));
      mapvinaMapOptions.attributionMargins(new int[] {
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiAttributionMarginLeft,
          NINETY_TWO_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiAttributionMarginTop,
          FOUR_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiAttributionMarginRight,
          FOUR_DP * pxlRatio)),
        (int) (typedArray.getDimension(R.styleable.mapvina_MapView_mapvina_uiAttributionMarginBottom,
          FOUR_DP * pxlRatio))});
      mapvinaMapOptions.textureMode(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_renderTextureMode, false));
      mapvinaMapOptions.translucentTextureSurface(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_renderTextureTranslucentSurface, false));
      mapvinaMapOptions.setPrefetchesTiles(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_enableTilePrefetch, true));
      mapvinaMapOptions.setPrefetchZoomDelta(
        typedArray.getInt(R.styleable.mapvina_MapView_mapvina_prefetchZoomDelta, 4));
      mapvinaMapOptions.renderSurfaceOnTop(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_enableZMediaOverlay, false));

      mapvinaMapOptions.localIdeographFontFamilyEnabled =
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_localIdeographEnabled, true);

      int localIdeographFontFamiliesResId =
        typedArray.getResourceId(R.styleable.mapvina_MapView_mapvina_localIdeographFontFamilies, 0);
      if (localIdeographFontFamiliesResId != 0) {
        ...
        mapvinaMapOptions.localIdeographFontFamily(localIdeographFontFamilies);
      } else {
        // did user provide xml font string?
        String localIdeographFontFamily =
          typedArray.getString(R.styleable.mapvina_MapView_mapvina_localIdeographFontFamily);
        if (localIdeographFontFamily == null) {
          localIdeographFontFamily = MapVinaConstants.DEFAULT_FONT;
        }
        mapvinaMapOptions.localIdeographFontFamily(localIdeographFontFamily);
      }

      mapvinaMapOptions.pixelRatio(
        typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_pixelRatio, 0));
      mapvinaMapOptions.foregroundLoadColor(
        typedArray.getInt(R.styleable.mapvina_MapView_mapvina_foregroundLoadColor, LIGHT_GRAY)
      );
      mapvinaMapOptions.crossSourceCollisions(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_cross_source_collisions, true)
      );

      mapvinaMapOptions.actionJournalEnabled(
        typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_actionJournalEnabled, false)
      );
      mapvinaMapOptions.actionJournalLogFileSize(
        typedArray.getInteger(R.styleable.mapvina_MapView_mapvina_actionJournalLogFileSize, 1024 * 1024)
      );
      mapvinaMapOptions.actionJournalLogFileCount(
        typedArray.getInteger(R.styleable.mapvina_MapView_mapvina_actionJournalLogFileCount, 5)
      );
      mapvinaMapOptions.actionJournalRenderingReportInterval(
              typedArray.getInteger(R.styleable.mapvina_MapView_mapvina_actionJournalRenderingReportInterval, 60)
      );

      mapvinaMapOptions.asyncRendererCleanup(
              typedArray.getBoolean(R.styleable.mapvina_MapView_mapvina_asyncRendererCleanup, false)
      );
    } finally {
      typedArray.recycle();
    }
  ...
  @Deprecated
  @NonNull
  public MapVinaMapOptions apiBaseUrl(String apiBaseUrl) {
   ...
   */
  @NonNull
  public MapVinaMapOptions apiBaseUri(String apiBaseUri) {
   ...
   */
  @NonNull
  public MapVinaMapOptions camera(CameraPosition cameraPosition) {
   ...
   */
  @NonNull
  public MapVinaMapOptions debugActive(boolean enabled) {
    debugActive = enabled;
    return this;
  }
   ...
   */
  @NonNull
  public MapVinaMapOptions minZoomPreference(double minZoom) {
   ...
   */
  @NonNull
  public MapVinaMapOptions maxZoomPreference(double maxZoom) {
   ...
   */
  @NonNull
  public MapVinaMapOptions minPitchPreference(double minPitch) {
   ...
   */
  @NonNull
  public MapVinaMapOptions maxPitchPreference(double maxPitch) {
    this.maxPitch = maxPitch;
    return this;
  }

  /**
   * Specifies the visibility state of a mapvina_compass_icon for a map view.
   *
   * @param enabled True and mapvina_compass_icon is shown
   * @return This
   */
  @NonNull
  public MapVinaMapOptions compassEnabled(boolean enabled) {
    compassEnabled = enabled;
    return this;
  }

  /**
   * Specifies the gravity state of mapvina_compass_icon for a map view.
   *
   * @param gravity Android SDK Gravity.
   * @return This
   */
  @NonNull
  public MapVinaMapOptions compassGravity(int gravity) {
    compassGravity = gravity;
    return this;
  }

  /**
   * Specifies the margin state of mapvina_compass_icon for a map view
   *
   * @param margins 4 long array for LTRB margins
   * @return This
   */
  @NonNull
  public MapVinaMapOptions compassMargins(int[] margins) {
    compassMargins = margins;
    return this;
  }

  /**
   * Specifies if the mapvina_compass_icon fades to invisible when facing north.
   * <p>
   * By default this value is true.
   * </p>
   *
   * @param compassFadeWhenFacingNorth true is mapvina_compass_icon fades to invisble
   * @return This
   */
  @NonNull
  public MapVinaMapOptions compassFadesWhenFacingNorth(boolean compassFadeWhenFacingNorth) {
   ...
   * <p>
   * By default this value is R.drawable.mapvina_compass_icon.
   * </p>
   *
   ...
   */
  @NonNull
  public MapVinaMapOptions compassImage(Drawable compass) {
   ...
   */
  @NonNull
  public MapVinaMapOptions logoEnabled(boolean enabled) {
    logoEnabled = enabled;
    return this;
  }
   ...
   */
  @NonNull
  public MapVinaMapOptions logoGravity(int gravity) {
    logoGravity = gravity;
    return this;
  }
   ...
   */
  @NonNull
  public MapVinaMapOptions logoMargins(int[] margins) {
    logoMargins = margins;
    return this;
  }
   ...
   */
  @NonNull
  public MapVinaMapOptions attributionEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions attributionGravity(int gravity) {
   ...
   */
  @NonNull
  public MapVinaMapOptions attributionMargins(int[] margins) {
   ...
   */
  @NonNull
  public MapVinaMapOptions attributionTintColor(@ColorInt int color) {
   ...
   */
  @NonNull
  public MapVinaMapOptions rotateGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions scrollGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions horizontalScrollGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions tiltGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions zoomGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions doubleTapGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions quickZoomGesturesEnabled(boolean enabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions textureMode(boolean textureMode) {
    this.textureMode = textureMode;
    return this;
  }

  @NonNull
  public MapVinaMapOptions translucentTextureSurface(boolean translucentTextureSurface) {
   ...
   */
  @NonNull
  public MapVinaMapOptions foregroundLoadColor(@ColorInt int loadColor) {
  ...
  @Deprecated
  @NonNull
  public MapVinaMapOptions setPrefetchesTiles(boolean enable) {
   ...
   * Note: This operation will override the MapVinaMapOptions#setPrefetchesTiles(boolean)
   ...
   */
  @NonNull
  public MapVinaMapOptions setPrefetchZoomDelta(@IntRange(from = 0) int delta) {
   ...
   */
  @NonNull
  public MapVinaMapOptions crossSourceCollisions(boolean crossSourceCollisions) {
   ...
   */
  @NonNull
  public MapVinaMapOptions actionJournalEnabled(boolean actionJournalEnabled) {
   ...
   */
  @NonNull
  public MapVinaMapOptions actionJournalPath(@NonNull String actionJournalPath) {
   ...
   */
  @NonNull
  public MapVinaMapOptions actionJournalLogFileSize(long actionJournalLogFileSize) {
   ...
   */
  @NonNull
  public MapVinaMapOptions actionJournalLogFileCount(long actionJournalLogFileCount) {
   ...
   */
  @NonNull
  public MapVinaMapOptions actionJournalRenderingReportInterval(int actionJournalRenderingReportInterval) {
   ...
   */
  @NonNull
  public MapVinaMapOptions asyncRendererCleanup(boolean asyncRendererCleanup) {
   ...
   */
  @NonNull
  public MapVinaMapOptions localIdeographFontFamilyEnabled(boolean enabled) {
   ...
   * Default font for local ideograph font family is {@link MapVinaConstants#DEFAULT_FONT}.
   *
   * @param fontFamily font family for local ideograph generation.
   * @return This
   */
  @NonNull
  public MapVinaMapOptions localIdeographFontFamily(String fontFamily) {
   ...
   * will be selected. If no valid font found, it defaults to {@link MapVinaConstants#DEFAULT_FONT}.
   * <p>
   ...
   * {@link MapVinaConstants#DEFAULT_FONT}.
   * </p>
   *
   ...
   */
  @NonNull
  public MapVinaMapOptions localIdeographFontFamily(String... fontFamilies) {
   ...
   */
  @NonNull
  public MapVinaMapOptions pixelRatio(float pixelRatio) {
  ...
  /**
   * Get the current configured visibility state for mapvina_compass_icon for a map view.
   *
   * @return Visibility state of the mapvina_compass_icon
   */
  ...
  /**
   * Get the current configured gravity state for mapvina_compass_icon for a map view.
   *
   * @return Gravity state of the mapvina_compass_icon
   */
  ...
  /**
   * Get the current configured margins for mapvina_compass_icon for a map view.
   *
   * @return Margins state of the mapvina_compass_icon
   */
  ...
  /**
   * Get the current configured state for fading the mapvina_compass_icon when facing north.
   *
   * @return True if mapvina_compass_icon fades to invisible when facing north
   */
  ...
  public static final Parcelable.Creator<MapVinaMapOptions> CREATOR = new Parcelable.Creator<MapVinaMapOptions>() {
    public MapVinaMapOptions createFromParcel(@NonNull Parcel in) {
      return new MapVinaMapOptions(in);
    }

    public MapVinaMapOptions[] newArray(int size) {
      return new MapVinaMapOptions[size];
    }
  };
  ...
  public boolean equals(@Nullable Object o) {
    ...
    MapVinaMapOptions options = (MapVinaMapOptions) o;
