...
public class LocationComponentOptions implements Parcelable {
  ...
  public static LocationComponentOptions createFromAttributes(@NonNull Context context,
    ...
    TypedArray typedArray = context.obtainStyledAttributes(
      styleRes, R.styleable.mapvina_LocationComponent);
    ...
    builder.foregroundDrawable(typedArray.getResourceId(
      R.styleable.mapvina_LocationComponent_mapvina_foregroundDrawable, -1));
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_foregroundTintColor)) {
      builder.foregroundTintColor(typedArray.getColor(
        R.styleable.mapvina_LocationComponent_mapvina_foregroundTintColor, -1));
    }
    builder.backgroundDrawable(typedArray.getResourceId(
      R.styleable.mapvina_LocationComponent_mapvina_backgroundDrawable, -1));
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_backgroundTintColor)) {
      builder.backgroundTintColor(typedArray.getColor(
        R.styleable.mapvina_LocationComponent_mapvina_backgroundTintColor, -1));
    }
    builder.foregroundDrawableStale(typedArray.getResourceId(
      R.styleable.mapvina_LocationComponent_mapvina_foregroundDrawableStale, -1));
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_foregroundStaleTintColor)) {
      builder.foregroundStaleTintColor(typedArray.getColor(
        R.styleable.mapvina_LocationComponent_mapvina_foregroundStaleTintColor, -1));
    }
    builder.backgroundDrawableStale(typedArray.getResourceId(
      R.styleable.mapvina_LocationComponent_mapvina_backgroundDrawableStale, -1));
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_backgroundStaleTintColor)) {
      builder.backgroundStaleTintColor(typedArray.getColor(
        R.styleable.mapvina_LocationComponent_mapvina_backgroundStaleTintColor, -1));
    }
    builder.bearingDrawable(typedArray.getResourceId(
      R.styleable.mapvina_LocationComponent_mapvina_bearingDrawable, -1));
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_bearingTintColor)) {
      builder.bearingTintColor(typedArray.getColor(
        R.styleable.mapvina_LocationComponent_mapvina_bearingTintColor, -1));
    }
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_enableStaleState)) {
      builder.enableStaleState(typedArray.getBoolean(
        R.styleable.mapvina_LocationComponent_mapvina_enableStaleState, true));
    }
    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_staleStateTimeout)) {
      builder.staleStateTimeout(typedArray.getInteger(
        R.styleable.mapvina_LocationComponent_mapvina_staleStateTimeout, (int) STALE_STATE_DELAY_MS));
    }
    builder.gpsDrawable(typedArray.getResourceId(
      R.styleable.mapvina_LocationComponent_mapvina_gpsDrawable, -1));
    float elevation = typedArray.getDimension(
      R.styleable.mapvina_LocationComponent_mapvina_elevation, 0);
    builder.accuracyColor(typedArray.getColor(
      R.styleable.mapvina_LocationComponent_mapvina_accuracyColor, -1));
    builder.accuracyAlpha(typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_accuracyAlpha, ACCURACY_ALPHA_DEFAULT));
    builder.elevation(elevation);

    builder.trackingGesturesManagement(typedArray.getBoolean(
      R.styleable.mapvina_LocationComponent_mapvina_trackingGesturesManagement, false));
    builder.trackingInitialMoveThreshold(typedArray.getDimension(
      R.styleable.mapvina_LocationComponent_mapvina_trackingInitialMoveThreshold,
      context.getResources().getDimension(R.dimen.mapvina_locationComponentTrackingInitialMoveThreshold)));
    builder.trackingMultiFingerMoveThreshold(typedArray.getDimension(
      R.styleable.mapvina_LocationComponent_mapvina_trackingMultiFingerMoveThreshold,
      context.getResources().getDimension(R.dimen.mapvina_locationComponentTrackingMultiFingerMoveThreshold)));

    builder.padding(new int[] {
      typedArray.getInt(R.styleable.mapvina_LocationComponent_mapvina_iconPaddingLeft, 0),
      typedArray.getInt(R.styleable.mapvina_LocationComponent_mapvina_iconPaddingTop, 0),
      typedArray.getInt(R.styleable.mapvina_LocationComponent_mapvina_iconPaddingRight, 0),
      typedArray.getInt(R.styleable.mapvina_LocationComponent_mapvina_iconPaddingBottom, 0),
    });

    builder.layerAbove(
      typedArray.getString(R.styleable.mapvina_LocationComponent_mapvina_layer_above));

    builder.layerBelow(
      typedArray.getString(R.styleable.mapvina_LocationComponent_mapvina_layer_below));

    float minScale = typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_minZoomIconScale, MIN_ZOOM_ICON_SCALE_DEFAULT);
    float maxScale = typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_maxZoomIconScale, MAX_ZOOM_ICON_SCALE_DEFAULT);
    ...
    float trackingAnimationDurationMultiplier = typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_trackingAnimationDurationMultiplier,
    ...
    builder.compassAnimationEnabled = typedArray.getBoolean(
      R.styleable.mapvina_LocationComponent_mapvina_compassAnimationEnabled, true
    );

    builder.accuracyAnimationEnabled = typedArray.getBoolean(
      R.styleable.mapvina_LocationComponent_mapvina_accuracyAnimationEnabled, true
    );

    builder.pulseEnabled = typedArray.getBoolean(
      R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleEnabled, false
    );

    builder.pulseFadeEnabled = typedArray.getBoolean(
      R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleFadeEnabled, true
    );

    if (typedArray.hasValue(R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleColor)) {
      builder.pulseColor(typedArray.getColor(
        R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleColor,
        -1));
    }

    builder.pulseSingleDuration = typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleDuration, CIRCLE_PULSING_DURATION_DEFAULT_MS
    );

    builder.pulseMaxRadius = typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleRadius, CIRCLE_PULSING_MAX_RADIUS_DEFAULT
    );

    builder.pulseAlpha = typedArray.getFloat(
      R.styleable.mapvina_LocationComponent_mapvina_pulsingLocationCircleAlpha, CIRCLE_PULSING_ALPHA_DEFAULT);
  ...
  public static Builder builder(@NonNull Context context) {
    return LocationComponentOptions.createFromAttributes(context,
      R.style.mapvina_LocationComponent).toBuilder();
  }
   ...
   * component, will use this image in place of the provided or default mapvina_foregroundDrawableStale.
   * <p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default mapvina_foregroundDrawableStale.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default mapvina_gpsDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default mapvina_foregroundDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default mapvina_backgroundDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default mapvina_bearingDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * {@link MapVinaMap#setGesturesManager(AndroidGesturesManager, boolean, boolean)}.
   *
  ...
  public static class Builder {
     ...
     * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
     * component, will used this image in place of the provided or default mapvina_backgroundDrawableStale.
     * <p>
     * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
     * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
     * </p>
