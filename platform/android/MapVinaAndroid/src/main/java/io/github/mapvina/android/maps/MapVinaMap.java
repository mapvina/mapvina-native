...
/**
 * The general class to interact with in the Android MapVina SDK. It exposes the entry point for all
 * methods related to the MapView. You cannot instantiate {@link MapVinaMap} object directly, rather,
 * you must obtain one from the getMapAsync() method on a MapFragment or MapView that you have
 * added to your application.
 * <p>
 * Note: Similar to a View object, a MapVinaMap should only be read and modified from the main thread.
 * </p>
 */
@UiThread
public final class MapVinaMap {

  private static final String TAG = "Mbgl-MapVinaMap";
  ...
  @Nullable
  private MapVinaMap.OnFpsChangedListener onFpsChangedListener;
  ...
  MapVinaMap(NativeMap map, Transform transform, UiSettings ui, Projection projection,
  ...
  void initialise(@NonNull Context context, @NonNull MapVinaMapOptions options) {
  ...
  void onSaveInstanceState(@NonNull Bundle outState) {
    outState.putParcelable(MapVinaConstants.STATE_CAMERA_POSITION, transform.getCameraPosition());
    outState.putBoolean(MapVinaConstants.STATE_DEBUG_ACTIVE, isDebugActive());
  ...
  void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
    final CameraPosition cameraPosition = savedInstanceState.getParcelable(MapVinaConstants.STATE_CAMERA_POSITION);
    ...
    nativeMapView.setDebug(savedInstanceState.getBoolean(MapVinaConstants.STATE_DEBUG_ACTIVE));
  }
   ...
   */
  private void setPrefetchesTiles(@NonNull MapVinaMapOptions options) {
   ...
   * @see MapVinaMap#setPrefetchesTiles(boolean)
   ...
   * @see MapVinaMap#setPrefetchZoomDelta(int)
   */
  @IntRange(from = 0)
   ...
   *
   * @return true if enabled
   * @see MapVinaMap#setTileCacheEnabled(boolean)
   */
   ...
   * @see MapVinaMap#setTileLodMinRadius(double)
   */
   ...
   * @see MapVinaMap#setTileLodScale(double)
   */
   ...
   * @see MapVinaMap#setTileLodPitchThreshold(double)
   */
   ...
   * TileLodZoomShift. {@link MapVinaMapOptions#pixelRatio(float)}
   */
   ...
   * @see MapVinaMap#setTileLodZoomShift(double)
   */
  ...
  public void setMinZoomPreference(
    @FloatRange(from = MapVinaConstants.MINIMUM_ZOOM, to = MapVinaConstants.MAXIMUM_ZOOM) double minZoom) {
   ...
   */
  public void setMaxZoomPreference(@FloatRange(from = MapVinaConstants.MINIMUM_ZOOM,
    to = MapVinaConstants.MAXIMUM_ZOOM) double maxZoom) {
  ...
  public void setMinPitchPreference(
    @FloatRange(from = MapVinaConstants.MINIMUM_PITCH, to = MapVinaConstants.MAXIMUM_PITCH) double minPitch) {
   ...
   */
  public void setMaxPitchPreference(@FloatRange(from = MapVinaConstants.MINIMUM_PITCH,
    to = MapVinaConstants.MAXIMUM_PITCH) double maxPitch) {
  ...
  public final void moveCamera(@NonNull final CameraUpdate update,
                               @Nullable final MapVinaMap.CancelableCallback callback) {
    notifyDeveloperAnimationListeners();
    transform.moveCamera(MapVinaMap.this, update, callback);
  }
  ...
  public final void easeCamera(@NonNull CameraUpdate update) {
    easeCamera(update, MapVinaConstants.ANIMATION_DURATION);
  }
   ...
   * @see CameraUpdateFactory for a set of updates.
   */
  public final void easeCamera(@NonNull CameraUpdate update, @Nullable final MapVinaMap.CancelableCallback callback) {
    easeCamera(update, MapVinaConstants.ANIMATION_DURATION, callback);
  }
  ...
  public final void easeCamera(@NonNull final CameraUpdate update,
    ...
    notifyDeveloperAnimationListeners();
    transform.easeCamera(MapVinaMap.this, update, durationMs, easingInterpolator, callback);
  }
  ...
  public final void animateCamera(@NonNull CameraUpdate update) {
    animateCamera(update, MapVinaConstants.ANIMATION_DURATION, null);
  }
   ...
   * @see CameraUpdateFactory for a set of updates.
   */
  public final void animateCamera(@NonNull CameraUpdate update, @Nullable MapVinaMap.CancelableCallback callback) {
    animateCamera(update, MapVinaConstants.ANIMATION_DURATION, callback);
  }
  ...
  public final void animateCamera(@NonNull final CameraUpdate update, final int durationMs,
    ...
    notifyDeveloperAnimationListeners();
    transform.animateCamera(MapVinaMap.this, update, durationMs, callback);
  }
  ...
  private void setApiBaseUrl(@NonNull MapVinaMapOptions options) {
   ...
   * MapVina Annotation Plugin</a> instead
   */
  @Deprecated
  @NonNull
  ...
  @Nullable
  public CameraPosition getCameraForLatLngBounds(@NonNull LatLngBounds latLngBounds,
                                                 @FloatRange(from = MapVinaConstants.MINIMUM_DIRECTION,
                                                   to = MapVinaConstants.MAXIMUM_DIRECTION) double bearing,
                                                 @FloatRange(from = MapVinaConstants.MINIMUM_TILT,
                                                   to = MapVinaConstants.MAXIMUM_TILT) double tilt) {
   ...
   *
   * @see MapVinaMap#addOnFlingListener(OnFlingListener)
   */
   ...
   *
   * @see MapVinaMap#addOnMoveListener(OnMoveListener)
   */
   ...
   *
   * @see MapVinaMap#addOnRotateListener(OnRotateListener)
   */
   ...
   *
   * @see MapVinaMap#addOnScaleListener(OnScaleListener)
   */
   ...
   *
   * @see MapVinaMap#addOnShoveListener(OnShoveListener)
   */
   ...
   *
   * @see MapVinaMap#setOnFpsChangedListener(OnFpsChangedListener)
   */
   ...
   *
   * @see MapVinaMap#addOnMapClickListener(OnMapClickListener)
   */
   ...
   *
   * @see MapVinaMap#addOnMapLongClickListener(OnMapLongClickListener)
   */
   ...
   *
   * @see MapVinaMap#setOnMarkerClickListener(OnMarkerClickListener)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * MapVina Annotation Plugin</a> instead
   */
   ...
   *
   * @see MapVinaMap#setOnPolygonClickListener(OnPolygonClickListener)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * MapVina Annotation Plugin</a> instead
   */
   ...
   *
   * @see MapVinaMap#setOnPolylineClickListener(OnPolylineClickListener)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * MapVina Annotation Plugin</a> instead
   */
   ...
   *
   * @see MapVinaMap#setOnInfoWindowClickListener(OnInfoWindowClickListener)
   */
   ...
   *
   * @see MapVinaMap#setOnInfoWindowCloseListener(OnInfoWindowCloseListener)
   */
   ...
   *
   * @see MapVinaMap#setInfoWindowAdapter(InfoWindowAdapter)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * MapVina Annotation Plugin</a> instead
   */
